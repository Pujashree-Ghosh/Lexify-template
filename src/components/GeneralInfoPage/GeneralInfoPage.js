...
export class GeneralInfoPageComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
    ...
    return (
      <Page className={css.root} title={title} scrollingDisabled={scrollingDisabled}>
        {/* <LayoutSingleColumn> */}
          ...
          <ProfilePageSideNav currentTab = "GeneralInfoPage"/>
          <LayoutWrapperMain>
...
GeneralInfoPageComponent.defaultProps = {
  currentUser: null,
...
GeneralInfoPageComponent.propTypes = {
