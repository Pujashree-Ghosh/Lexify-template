...
const ProfilePageSideNavComponent = props => {
  ...
  const tabs = [
    ...
    {
      text: <FormattedMessage id="ProfilePageSideNav.bufferTime" />,
      selected: currentTab === 'BufferTimePage',
      id: 'BufferTimePage',
      linkProps: {
        name: 'BufferTimePage',
      },
...
const ProfilePageSideNav = compose(withViewport)(ProfilePageSideNavComponent);
