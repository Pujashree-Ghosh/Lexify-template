...
export const countryLanguage = [
  ...
  {
    country: 'Bangladesh',
    languages: ['Bengali', 'Chakma', 'Garo', 'Khasi', 'Marma', 'Santhali', 'Tripuri'],
  },
  {
    country: 'Bulgaria',
  ...
  {
    country: 'Brazil',
    languages: ['German', 'Indian Languages', 'Italian', 'Japanese', 'Portuguese'],
  },
  {
    country: 'Barbados',
  ...
  {
    country: 'Cameroon',
    languages: ['Bamileke-bamum', 'Duala', 'Fang', 'Ful', 'Maka', 'Mandara', 'Masana', 'Tikar'],
  },
  {
  ...
  {
    country: 'Germany',
    languages: ['German', 'Greek', 'Italian', 'Polish', 'Southern Slavic Languages', 'Turkish'],
  },
  {
    country: 'Djibouti',
  ...
  {
    country: 'Denmark',
    languages: ['Arabic', 'Danish', 'English', 'German', 'Norwegian', 'Swedish', 'Turkish'],
  },
  {
  ...
  {
    country: 'Ethiopia',
    languages: ['Amharic', 'Gurage', 'Oromo', 'Sidamo', 'Somali', 'Tigrigna', 'Walaita'],
  },
  {
    country: 'Finland',
  ...
  {
    country: 'France',
    languages: ['Arabic', 'French', 'Italian', 'Portuguese', 'Spanish', 'Turkish'],
  },
  {
  ...
  {
    country: 'Georgia',
    languages: ['Abhyasi', 'Armenian', 'Azerbaijani', 'Georgiana', 'Osseetti', 'Russian'],
  },
  {
    country: 'Ghana',
  ...
  },
  {
    ...
    languages: ['Balante', 'Crioulo', 'Ful', 'Malinke', 'Mandyako', 'Portuguese'],
  },
  {
  ...
  {
    country: 'Guam',
    languages: ['Chamorro', 'English', 'Japanese', 'Korean', 'Philippene Languages'],
  },
  {
    country: 'Guyana',
  ...
  {
    country: 'Hungary',
    languages: ['German', 'Hungarian', 'Romani', 'Romanian', 'Serbo-Croatian', 'Slovak'],
  },
  {
    country: 'Indonesia',
    languages: [
  ...
  {
    country: 'Japan',
    languages: ['Ainu', 'Chinese', 'English', 'Japanese', 'Korean', 'Philippene Languages'],
  },
  {
    country: 'Kazakhstan',
  ...
  {
    country: 'Kyrgyzstan',
    languages: ['Kazakh', 'Kirgiz', 'Russian', 'Tadzhik', 'Tatar', 'Ukrainian', 'Uzbek'],
  },
  {
    country: 'Cambodia',
    languages: ['Chinese', 'Khmer', 'Tam', 'Vietnamese'],
  },
  {
    country: 'Kiribati',
  ...
  {
    country: 'Liberia',
    languages: ['Bassa', 'Gio', 'Grebo', 'Kpelle', 'Kru', 'Loma', 'Malinke', 'Mano'],
  },
  {
  ...
  {
    country: 'Latvia',
    languages: ['Belorussian', 'Latvian', 'Lithuanian', 'Polish', 'Russian', 'Ukrainian'],
  },
  {
    country: 'Macao',
  ...
  {
    country: 'Macedonia',
    languages: ['Albaniana', 'Macedonian', 'Romani', 'Serbo-Croatian', 'Turkish'],
  },
  {
    country: 'Mali',
    languages: ['Bambara', 'Ful', 'Senufo and Minianka', 'Songhai', 'Soninke', 'Tamashek'],
  },
  {
    country: 'Malta',
  ...
  {
    country: 'Myanmar',
    languages: ['Burmese', 'Chin', 'Kachin', 'Karen', 'Kayah', 'Mon', 'Rakhine', 'Shan'],
  },
  {
    country: 'Mongolia',
  ...
  },
  {
    ...
    languages: ['Carolinian', 'Chamorro', 'Chinese', 'English', 'Korean', 'Philippene Languages'],
  },
  {
    country: 'Mozambique',
    languages: [
  ...
  {
    country: 'Mauritius',
    languages: ['Bhojpuri', 'Creole French', 'French', 'Hindi', 'Marathi', 'Tamil'],
  },
  {
    country: 'Malawi',
  ...
  {
    country: 'Namibia',
    languages: ['Afrikaans', 'Caprivi', 'German', 'Herero', 'Kavango', 'Nama', 'Ovambo', 'San'],
  },
  {
  ...
  {
    country: 'Nigeria',
    languages: ['Bura', 'Edo', 'Ful', 'Hausa', 'Ibibio', 'Ibo', 'Ijo', 'Joruba', 'Kanuri', 'Tiv'],
  },
  {
    country: 'Nicaragua',
  ...
  {
    country: 'Nepal',
    languages: ['Bhojpuri', 'Hindi', 'Maithili', 'Nepali', 'Newari', 'Tamang', 'Tharu'],
  },
  {
    country: 'Nauru',
  ...
  {
    country: 'Pakistan',
    languages: ['Balochi', 'Brahui', 'Hindko', 'Pashto', 'Punjabi', 'Saraiki', 'Sindhi', 'Urdu'],
  },
  {
    country: 'Panama',
    languages: ['Arabic', 'Creole English', 'Cuna', 'Embera', 'Guaymí', 'Spanish'],
  },
  {
    country: 'Pitcairn',
  ...
  {
    country: 'Romania',
    languages: ['German', 'Hungarian', 'Romani', 'Romanian', 'Serbo-Croatian', 'Ukrainian'],
  },
  {
  ...
  },
  {
    ...
    languages: ['Malenasian Languages', 'Papuan Languages', 'Polynesian Languages'],
  },
  {
  ...
  {
    country: 'Slovakia',
    languages: ['Czech and Moravian', 'Hungarian', 'Romani', 'Slovak', 'Ukrainian and Russian'],
  },
  {
    country: 'Slovenia',
  ...
  {
    country: 'Togo',
    languages: ['Ane', 'Ewe', 'Gurma', 'Kabyé', 'Kotokoli', 'Moba', 'Naudemba', 'Watyi'],
  },
  {
    country: 'Thailand',
  ...
  {
    country: 'Vietnam',
    languages: ['Chinese', 'Khmer', 'Man', 'Miao', 'Muong', 'Nung', 'Thai', 'Tho', 'Vietnamese'],
  },
  {
    country: 'Vanuatu',
